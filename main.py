...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/txtuploder"),
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"**If you have any questions, feel free to ask [🇰 🇦 🇱 🇻 🇮 🇳 🐦](https://t.me/txtuploder)! 💬**\n"
        )
    ) 
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [🇰 🇦 🇱 🇻 🇮 🇳 🐦](https://t.me/txtuploder)"
